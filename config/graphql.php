...
//    ],
    ...
    'schemas' => [
        'default' => [
            'query' => [
//                //'category' => CrCms\Category\Http\GraphQL\Category\CategoryQuery::class
//                //\CrCms\Category\Http\GraphQL\Queries\CategoryQuery::class,
            ],
            'mutation' => [
//                'CategoryMutation' => \CrCms\Category\Http\GraphQL\Category\CategoryMutation::class,
            ]
        ],
        /*'category' => [
            'query' => [
     ...
     */
    'types' => [
//        CrCms\Category\Http\GraphQL\Category\CategoryType::class
//        \CrCms\Category\Http\GraphQL\Types\CategoryType::class,
//        \CrCms\Category\Http\GraphQL\Types\EnumTest::class,
    ],
