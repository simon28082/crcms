...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/h-ui/css/H-ui.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/h-ui.admin/css/H-ui.admin.css')}}" />
    ...
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/h-ui.admin/skin/default/skin.css')}}" id="skin" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/h-ui.admin/css/style.css')}}" />
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="{{route('manage.index.description.get')}}"></iframe>
        </div>
    </div>
</section>
<script src="{{static_asset('vendor/common/js/jquery-2.1.3.min.js')}}"></script>
<script src="{{static_asset('vendor/vue/vue.min.js')}}"></script>
<script src="{{static_asset('vendor/h-ui-admin/lib/layer/2.1/layer.js')}}"></script>
<script src="{{static_asset('vendor/h-ui-admin/h-ui/js/H-ui.js')}}"></script>
<script src="{{static_asset('vendor/h-ui-admin/h-ui.admin/js/H-ui.admin.js')}}"></script>
<script src="{{static_asset('vendor/manage/js/manage.js')}}"></script>
<script>
    /*资讯-添加*/
