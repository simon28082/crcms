...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/static/h-ui/css/H-ui.min.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/static/h-ui.admin/css/H-ui.admin.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/lib/Hui-iconfont/1.0.7/iconfont.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/lib/icheck/icheck.css')}}" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/static/h-ui.admin/skin/default/skin.css')}}" id="skin" />
    <link rel="stylesheet" type="text/css" href="{{static_asset('vendor/h-ui-admin/static/h-ui.admin/css/style.css')}}" />
</head>
<body>
                ...
                <ul class="cl">
                    <li class="dropDown dropDown_hover"><a href="javascript:;" class="dropDown_A"><i class="Hui-iconfont">&#xe600;</i> 新增 <i class="Hui-iconfont">&#xe6d5;</i></a>
                        <ul class="dropDown-menu menu radius box-shadow">
                            <li><a href="javascript:;" onclick="$.tool.open('添加资讯','{{route('admins.create')}}')"><i class="Hui-iconfont">&#xe616;</i> 资讯</a></li>
...
<aside class="Hui-aside">
    ...
    <div class="menu_dropdown bk_2">
        <dl id="menu-article">
            ...
            <dd>
                <ul>
                    <li><a _href="{{route('admins.index')}}" data-title="资讯管理" href="javascript:void(0)">资讯管理</a></li>
                </ul>
            </dd>
        </dl>
        <dl id="menu-picture">
...
<section class="Hui-article-box">
    ...
    <div id="iframe_box" class="Hui-article">
        <div class="show_iframe">
            ...
            <iframe scrolling="yes" frameborder="0" src="{{route('categories.index')}}"></iframe>
        </div>
    </div>
</section>
@include('kernel::script')
<script src="{{static_asset('vendor/layer/layer.js')}}"></script>
<script src="{{static_asset('vendor/h-ui-admin/static/h-ui/js/H-ui.js')}}"></script>
<script src="{{static_asset('vendor/h-ui-admin/static/h-ui.admin/js/H-ui.admin.js')}}"></script>
<script>
    /*资讯-添加*/
